...
ActiveRecord::Schema[7.0].define(version: 2022_11_26_124646) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "categories", force: :cascade do |t|
    t.string "name"
    t.string "icon", default: "https://p.kindpng.com/picc/s/459-4595417_category-overview-icon-hd-png-download.png"
